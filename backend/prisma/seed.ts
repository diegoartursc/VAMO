    ...
    const pkgs = [
        {
            ...
            fullDescription: 'Paris em 7 dias é o equilíbrio perfeito entre romance e cultura.',
            ...
            includedItems: ['Passagens aéreas internacionais', 'Hospedagem hotel 4 estrelas (6 noites)', 'Café da manhã continental', 'Transfer aeroporto-hotel'],
            notRecommendedFor: ['Viajantes que buscam aventura radical'],
            importantInfo: ['Passaporte com validade mínima de 6 meses'],
