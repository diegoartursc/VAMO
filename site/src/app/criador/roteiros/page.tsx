        ...
        <>
            ...
            <div className="itinerary-table">
                <div className="table-header">
                    ...
                    <Link href="/criador/roteiro/new">
                        <button className="btn-new">+ Novo Roteiro</button>
                    </Link>
                </div>

                <div className="table-row table-row-head" style={{ gridTemplateColumns: "2.5fr 1fr 1fr 1.5fr 1fr 120px" }}>
                ...
                {itineraries.length === 0 ? (
                    <div className="table-row">
                        <div className="table-cell" style={{ gridColumn: "1 / -1", textAlign: "center", padding: "2rem" }}>
                            ...
                            <Link href="/criador/roteiro/new" style={{ color: "var(--teal)", marginLeft: 8 }}>
                    ...
                    itineraries.map((it) => (
                        <div className="table-row" key={it.id}>
                            ...
                            <div className="table-cell table-actions">
                                <Link href={`/criador/roteiro/${it.id}`}>
