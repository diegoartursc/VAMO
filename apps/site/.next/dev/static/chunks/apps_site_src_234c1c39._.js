...
function RoteiroEditorPage({ params }) {
    ...
    /* ─── UI state ─── */ const [openSections, setOpenSections] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Set([
        "identity"
    ]));
    ...
    /* ─── Load data ─── */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoteiroEditorPage.useEffect": ()=>{
            if (isNew) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$site$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getItineraryById"])(id).then({
                "RoteiroEditorPage.useEffect": (data)=>{
                    setTitle(data.title || "");
                    ...
                    setImages(Array.isArray(data.images) ? data.images.map({
                        "RoteiroEditorPage.useEffect": (img)=>typeof img === "string" ? img : img.url
                    }["RoteiroEditorPage.useEffect"]) : [
                        ""
                    ]);
                    ...
                    setDays((data.days || []).map({
                        "RoteiroEditorPage.useEffect": (d)=>({
                                dayNumber: d.dayNumber,
                                title: d.title || "",
                                summary: d.summary || "",
                                description: d.description || "",
                                activities: (d.activities || []).map({
                                    "RoteiroEditorPage.useEffect": (a)=>({
                                            title: a.title || "",
    ...
    /* ─── Auto-save ─── */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RoteiroEditorPage.useEffect": ()=>{
            if (isNew) return;
            autoSaveRef.current = setInterval({
                "RoteiroEditorPage.useEffect": ()=>{
                    if (dirty) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$site$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["updateItinerary"])(id, buildPayload()).then({
                            "RoteiroEditorPage.useEffect": ()=>setDirty(false)
                        }["RoteiroEditorPage.useEffect"]).catch({
                            "RoteiroEditorPage.useEffect": ()=>{}
                        }["RoteiroEditorPage.useEffect"]);
                    }
                }
            }["RoteiroEditorPage.useEffect"], 30000);
            return ({
                "RoteiroEditorPage.useEffect": ()=>{
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: SECTIONS.map((sec)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            openSections.has(sec.key) && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(RoteiroEditorPage, "yg8fwJdvb1DpKOLph9Mbg6mmeFA=");
...
//# sourceMappingURL=apps_site_src_234c1c39._.js.map